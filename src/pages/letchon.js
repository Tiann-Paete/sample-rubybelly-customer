...
const Letchon = () => {
    ...
    useEffect(() => {
        ...
        const fetchProducts = async () => {
            try {
                ...
                const lechonProducts = response.data;
                setProducts(lechonProducts);
            } catch (error) {
    ...
    const cartItemCount = cartItems.length;  // Changed this line
            ...
            <div className="relative flex flex-col md:flex-row items-center justify-around w-full px-4 py-6">
                ...
                {lechonBelly && (
                    <div className="relative bg-[#ff6b35] text-white rounded-lg shadow-lg p-6 md:p-10 mb-6 md:mb-0 md:w-[45%] translate-y-8">
                        <button 
                            className="absolute top-0 right-0 transform translate-x-4 -translate-y-4 overflow-hidden rounded-full border-4 border-white"
                        ...
                        <div className="ml-72 mt-8 flex items-center space-x-4">  
                            <h2 className="text-4xl font-bold mb-4">{lechonBelly.name}</h2>
                            <button 
                ...
                {lechonBaboy && (
                    <div className="left-8 relative bg-[#ff6b35] text-white rounded-lg shadow-lg p-6 md:p-10 md:mb-0 md:w-[45%] -translate-y-8">
                        <button 
                            className="absolute top-0 left-0 transform -translate-x-4 -translate-y-4 overflow-hidden rounded-full border-4 border-white"
